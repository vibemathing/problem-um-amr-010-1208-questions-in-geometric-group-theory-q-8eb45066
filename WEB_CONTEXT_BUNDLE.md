...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-1208-questions-in-geometric-group-theory-q-8eb45066",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-1208-f1ca8b097963",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-1208"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Does Out(Fn) (n > 2) have a right orderable subgroup of finite index?",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 12.8",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "52a3dcf4cce8f8e0e1a9f4a24b5ee475a4b5555db386a57eb1b26cd2fb7e820b"
}
```
